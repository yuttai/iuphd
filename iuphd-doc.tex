...
\end{verbatim}
and the precise code for adding a bibliography for each section can be seen in \code{https://git.io/fhj8U}, \code{https://git.io/fhj8I}, and \code{https://git.io/fhj8q} if you use \code{biblatex} package.
